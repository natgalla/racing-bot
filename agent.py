...
For passive messages that pass the SKIP check, use only local sources — pins, events, channel history, the GT7 car database, and the tuning engine. If the answer is not available from those sources, SKIP rather than guessing."""
